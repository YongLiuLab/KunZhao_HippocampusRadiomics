...
function fea=radiomic_3rd_Texture(I,T,nLGLCM,nLGLRL)        %T==mask
% nLGLCM=8;nLGLRL=8; % for debugging
warning off %#ok<WNOFF>
  %% GLCM: 
  IT=I;
  IT(~T)=NaN;                               %除mask之外的点，赋值为NaN
