...
resdir = 'D:\FF\FLAN\Feature_extraction\test\out_feature\WT\';
...
%     end
    ...
    for kk = 1:8
        ...
        fea_1st(i,kk) = radiomic_1st_feature(Rec{kk},tu_img);
        fea_2nd(i,kk) =radiomic_2nd_ShapeSize(Rec{kk},tu_img);
        fea_3rd(i,kk)=radiomic_3rd_Texture(Rec{kk},tu_img,32,16);
